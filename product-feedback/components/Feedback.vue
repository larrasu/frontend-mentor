<template>
  <div
    class="flex flex-wrap gap-4 p-6 bg-white text-accent-200 text-[13px] tracking-[-0.18px]"
  >
    <div class="order-2">
      <!-- TODO: upvote -->
    ...
    <div class="basis-full space-y-[9px]">
      <h3 class="text-accent-200 font-bold">
        {{ feedback.title }}
      </h3>
...
const category =
  ...
  props.feedback.category.slice(1);
</script>
